...
Некоторые из ключевых слов Kotlin являются валидными идентификаторами в Java: `in`,
`object`, `is`, и т.д.
...
Любая ссылка в Java может принимать значение `null`, что делает требования Kotlin по null-safety
